...
<div class="error-page">
    <div class="container">
        <div class="title-error FreightDispProBook">
            <?php the_field('f_error_title', 'option'); ?>
        </div>
        <div class="lin-left"><span></span></div>
        <div class="error-page__row">
            <!-- don't show mob -->
            <div class="error-t-s FreightDispProBook mob-none">
                <?php the_field('f_error_sub_title', 'option'); ?>
            </div>
            <div class="error-404 FreightDispProBook">404</div>
        </div>
        <!-- don't show on pc -->
        <div class="error-t-s FreightDispProBook pc-none">
            <?php the_field('f_error_sub_title', 'option'); ?>
        </div>
